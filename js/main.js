...
function getZodiac() { 
  ...
  let userZodiac = {};
  let userTitle = document.getElementById('name').value;
...
if(birthMonth == 12 &&  birthDate >= 22 || birthMonth == 1 && birthDate <= 19){
  ...
  console.log(userZodiac.name);
  document.getElementById('zodiac').classList.toggle('hide')
  document.getElementById('resultScreen').classList.toggle('hide')
  document.querySelector('#resultMessage').innerText = `Hello ${userTitle}! Here are your Zodiac results!`
